...
product = releasedata.Product("microsoft2023")
session = HTMLSession()
r = session.get('https://learn.microsoft.com/en-us/lifecycle/end-of-support/end-of-support-2027')
